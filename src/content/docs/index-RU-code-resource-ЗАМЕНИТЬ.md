...
- **[Модификаторы](/MDC/code-resource/modifiers/)** — Economic, Law, Migration, Influence, Energy, Political модификаторы, разложенные по категориям и подкатегориям
- **[Скриптовые эффекты](/MDC/code-resource/effects/)** — эффекты для построек, экономики, фракций, влияния, политики, ЕС, антитеррора и картелей
- **[Гайды / How-To](/MDC/code-resource/guides/)** — добавление субидеологий, исторические события (ETD), работа с переменными, уникальные terrain-фото
