...
| `local_resources_factor` | Меняет эффективность добычи **всех** ресурсов сразу, в процентах | Для конкретного ресурса — `state_resource_<ресурс>` / `state_resources_factor`, см. [Региональные модификаторы](../regional/#vanilla) |
