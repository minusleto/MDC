...
Это базовое знакомство с переменными и самый простой способ начать ими пользоваться. Эти гибкие эффекты можно применять множеством способов как в отдельных системах, так и в обычных эффектах.
