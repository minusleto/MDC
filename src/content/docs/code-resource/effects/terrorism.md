...
:::note
Это эффекты для стран, поддерживающих терроризм. Противоположная механика, отражающая ответ стран Counter Terror, описана в разделе [Контртерроризм](../../systems/terrorism/).
:::
