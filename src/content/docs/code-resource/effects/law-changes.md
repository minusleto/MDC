---
title: Смена законов
description: "Эффекты смены законов: гражданские свободы (цензура, собрания, интернет, религия, ЛГБТ, профсоюзы), демография и деторождение, оружие, экономические законы (базовые эффекты, налоги, соглашения, расходы, торговля, миграция, бюрократия)"
---
...
Законы и эффекты, регулирующие казну, долги, инвестиции, налоги, экономические соглашения, государственные расходы, торговлю, военные расходы и миграцию.

<a id="basic-economic-effects"></a>
### Базовые эффекты

Базовые экономические эффекты, связанные с казной, долгами и инвестициями.

> В текущем файле нет отдельных `set_*` эффектов для казны, долгов и инвестиций, поэтому конкретные эффекты для них здесь не добавляются, чтобы не придумывать названия.

<a id="tax-changes"></a>
### Смена налогов

Налоговые законы: подоходный и корпоративный налог.

> В текущем файле нет отдельных эффектов смены подоходного и корпоративного налогов.

<a id="economic-agreements"></a>
### Экономические соглашения

Экономические соглашения между странами. Торговое и инвестиционное соглашения можно использовать одновременно.

| Эффект | Применение |
|---|---|
| `set_improved_trade_agreement = yes` | Установить улучшенное торговое соглашение |
| `set_mutual_investment_treaty = yes` | Установить взаимный инвестиционный договор |
