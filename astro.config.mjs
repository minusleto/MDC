			...
			sidebar: [
				{ label: 'Code Resource', translations: { en: 'Code Resource' }, items: [
					...
					{ label: 'Эффекты', translations: { en: 'Effects' }, items: [
						...
						{ label: 'Смена законов', translations: { en: 'Law Changes' }, items: [
							{ label: 'Обзор', slug: 'code-resource/effects/law-changes' },
						...
						{ label: 'Разное', translations: { en: 'Misc' }, slug: 'code-resource/effects/misc' },
					] },
					...
					{ label: 'Триггеры', translations: { en: 'Triggers' }, items: [
						...
						{ label: 'Картели', translations: { en: 'Cartels' }, slug: 'code-resource/triggers/cartels' },
					] },
					...
					{ label: 'Системы MDC', translations: { en: 'MDC Systems' }, items: [
						...
						{ label: 'НАТО', translations: { en: 'NATO' }, slug: 'code-resource/systems/nato' },
					] },
					{ label: 'Гайды', translations: { en: 'Guides' }, items: [
						...
						{ label: 'Выборы и коалиции', translations: { en: 'Elections & Coalitions' }, slug: 'code-resource/guides/elections' },
					] },
